...
BODY_SKIN_API_URL = "https://skins.mcstats.com/body/front/{uuid}?scale=2&fov=50&shadow=false&disableCosmeticType=all&fallbackTexture=alex&overlay=true&fallbackBehavior=graceful&cropMeasurement=percent&expandMeasurement=pixels&cropLeft=3&cropRight=3&cropTop=0&cropBottom=0&expandLeft=0&expandRight=0&expandTop=0&expandBottom=0&alwaysSquare=false&grayscale=false"
